...
{
    public partial class frmOpcServerCihazIzle : Form
    {

         int CihazAdedi = 0;
        //UserControlCihazTanim[] cihaztanim = null;
        ...
        public frmOpcServerCihazIzle()
        {
            ...
            //mymodel.Cihaz cihaz = new mymodel.Cihaz();
            //cihaz.Adi = "Klima 1";
            //cihaz.Davranis = mymodel.myenum.Davranis.OkuveYaz;
            //cihaz.IsotomatikCalisir = true;
            //cihaz.IsResetlenebilir = true;
            //cihaz.IsSigortasiVar = true;
            //cihaz.OkumaAdresi = "[Power]B70:0,L1,C1";
            //cihaz.OtmatikCalismaAdresi = "[Power]N60:0,L1,C1";
            //cihaz.ResetAdresi = "Power!'N60:0,L1,C1";
            //cihaz.SigortaAdresi = "Power!'N60:0,L1,C1";
            //cihaz.YazmaAdresi = "[Power]B70:0,L1,C1";         
            //cihaztanim = new UserControlCihazTanim[2];
            //userControlCihazTanim1.CihazNo = 1;
            //userControlCihazTanim2.CihazNo = 2;
            //cihaztanim[0] = userControlCihazTanim1;
            //cihaztanim[1] = userControlCihazTanim2;
            //cihaztanim[0].Cihaz = cihaz;
            //cihaztanim[1].Cihaz = cihaz;
            ...
            //{
            //    cihaztanim[i-1].buttonYaz.Click+=new EventHandler(_OPCItemWriteButton_0_Click);
            //    OPCItemWriteButton[i] = cihaztanim[i-1].buttonYaz;
            //    OPCItemValue[i] = cihaztanim[i - 1].textBoxOkunanDeger;
            //}
            ...
            if (ConnectedGroup != null)
            {
                ...
                try
                {
                    ...
                    switch (CanonDT)
                    {
                        ...
                        //chztnm.textBoxYazilacakDeger.Text;
            ...
            if ((ConnectedGroup != null))
            {
                try
                {
                    ...
                    for (int i = 1; i <= CihazAdedi; i++)
                    {
                        ...
                        //OPCItemIDs[i] = chz.Cihaz.OkumaAdresiFormulu;// OPCItemName[i].Text;
