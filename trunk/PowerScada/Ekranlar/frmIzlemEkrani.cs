...
//                and Adres.Aktif=@prm0 ",new object[]{true});
            ...
            LokasyonuGetir(lokasyons[0].ToString());
     }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(mngr.GetOPCItemSyncRead("power", listBox1.SelectedItem.ToString()));
        }

        private void button1_Click(object sender, EventArgs e)
        {
            if (listBox1.SelectedItem != null && textBox1.Text != string.Empty)
                mngr.OPCItemWrite("power",listBox1.SelectedItem.ToString(), textBox1.Text);
        }
