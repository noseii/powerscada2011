...
{
    public partial class frmForm18B : Form
    {
        public frmForm18B()
        {
            InitializeComponent();
        ...
        public  string  Sql()
        {
            ...
            strbldr.Append(@"exec dbo.SpForm18BRaporu '" + dateEditBasTarih.DateTime.ToString("yyyyMMdd") + "','" + dateEditBitTarih.DateTime.ToString("yyyyMMdd") + @"'," + Current.AktifDoktorId);
        ...
        {
            Sorgula();
            Form18BRprt rprprotokoldefteri = new Form18BRprt();
