...
{
    public partial class frmAileHekimiLohusaListesi : frmRaporBase
    {
        public frmAileHekimiLohusaListesi()
        {
            InitializeComponent();
        ...
        public override string Sql()
        {
            ...
            FROM
            Hasta h
            INNER JOIN GebeBaslangic gb on gb.Hasta_Id=h.Id and GebelikDurumu='Bitti'
            WHERE
